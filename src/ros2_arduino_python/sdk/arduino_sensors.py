...
from interface_arduino.msg import *
...
class Sensor(object):
    def __init__(self, node, controller, name, pin, rate, frame_id, direction="input", **kwargs):
        self.node = node
        ...
        self.t_next = Clock().now() + self.t_delta
    ...
    def poll(self):
        ...
        if now > self.t_next:
            ...
            self.msg.header.stamp = Clock().now()
...
class AnalogSensor(Sensor):
    def __init__(self, *args, **kwargs):
        ...
        self.pub = self.node.create_publisher(Analog, 'sensor', 5)
...
class AnalogFloatSensor(Sensor):
    def __init__(self, *args, **kwargs):
        ...
        self.pub = self.node.create_publisher(AnalogFloat, f'sensor/{self.name}', 5)
...
class DigitalSensor(Sensor):
    def __init__(self, *args, **kwargs):
        ...
        self.pub = self.node.create_publisher(Digital, f'sensor/{self.name}', 5)
...
class RangeSensor(Sensor):
    def __init__(self, *args, **kwargs):
        ...
        self.pub = self.node.create_publisher(Range, f'sensor/{self.name}', 5)
